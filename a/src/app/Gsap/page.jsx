...
const EmblaCarousel = () => {
  ...
  return (
    // <div className=" h-screen px-10 bg-gradient-to-tl from-red-700 to-red-300  flex justify-around items-center overflow-hidden p4">
    //   <div className=" w-[900px] ">
    //     <h1 className="text-7xl font-bold text-white mb-4">
    //       Elevate Your Style with Our Jackets
    //     </h1>
    //     <p className="text-sm text-white mb-6 line-clamp-4 w-">
    //     Discover the perfect blend of comfort and fashion with our exclusive jacket collection, meticulously crafted to elevate your wardrobe. Each piece combines premium materials and innovative designs, ensuring you not only look stylish but feel confident in every setting. Whether you’re heading out for a casual outing or dressing up for a night on the town, our jackets are designed to be versatile companions, ready to enhance your unique style and keep you warm.
    //     </p>
    ...
    //   </div>
    //   <div className="          ">
    //     <section className="embla borderr bg-red-400   w-[650px] h-[] overflow-hiden">
    //       <div className="embla__viewprt overflow-hidden" ref={emblaRef}>
    ...
    //                   className="embla__slide__number img  "
    //                   alt="image"
    //                   width={700}
    //                   height={100}
    //                 />
    ...
    // ">
<div className="h-screen px-5 md:px-10 bg-gradient-to-tl from-red-700 to-red-300 flex flex-col md:flex-row justify-around items-center overflow-hidden">
  <div className="w-full md:w-[900px]">
    <h1 className="text-4xl md:text-7xl font-bold text-white mb-4">
      Elevate Your Style with Our Jackets
    </h1>
    <p className="text-xs md:text-sm text-white mb-6 line-clamp-4">
      Discover the perfect blend of comfort and fashion with our exclusive jacket collection, meticulously crafted to elevate your wardrobe. Each piece combines premium materials and innovative designs, ensuring you not only look stylish but feel confident in every setting. Whether you’re heading out for a casual outing or dressing up for a night on the town, our jackets are designed to be versatile companions, ready to enhance your unique style and keep you warm.
    </p>
  ...
  <div className="mt-6 md:mt-0">
    <section className="embla borderr bg-red-400 w-full md:w-[650px] overflow-hiden">
